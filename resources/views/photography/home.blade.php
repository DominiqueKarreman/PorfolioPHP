    ...
    <body>
        ...
        <div id="fullpage">
                ...
                <div class="menu flex h-[50vh] sm:h-[45vh] w-[80vh] float-right justify-end text-right mr-5">
                    <ul id="menu" class="flex justify-between flex-row flex-wrap text-right ">
                        <li data-menuanchor="Home"
                            class="h-[5vh] relative flex items-center w-full text-right justify-end place-content-end">
                            <button data-text="Home" class="menuButton  text-[9vh] drop">Home</button></li>
                        <li
                        ...
                        <li data-menuanchor="Skills"
                            class="h-[5vh] relative flex items-center w-full text-right justify-end place-content-end">
                            <button data-text="About" class="menuButton text-[9vh] drop">About</button></li>
                        <li data-menuanchor="Skills"
                            class="h-[5vh] relative flex items-center w-full text-right justify-end place-content-end">
                            <button data-text="Timeline" class="menuButton text-[9vh] drop">Timeline</button></li>
                        <li data-menuanchor="Skills"
                            class="h-[5vh] relative flex items-center w-full text-right justify-end place-content-end">
                            <button data-text="Gear" class="menuButton text-[9vh] drop">Gear</button></li>
                        <li data-menuanchor="Skills"
                            class="h-[5vh] relative flex items-center w-full text-right justify-end place-content-end">
                            <button data-text="Hire" class="menuButton text-[9vh] drop">Hire</button></li>
            ...
            <div id="Work" class="section s2 flex center midd">
                ...
                <div data-mouse-down-at="0" data-prev-percentage="0" data-prev-percentage-slow="0"
                    data-mouse-down-at-slow="0"
                    style="translate(0%, -50%); object-position: 0% center; pointer-events: none" class="image-track">
                    ...
                    <button style="pointer-events: auto;"class="workButton">Go to portfolio</button>
                    <h1 class="workTitle">My work</h1>
                    <button style="pointer-events: auto;" id="sm" class="workButtonSm">Go to portfolio</button>
                    <img class="image image-track-img" src="http://www.dominiquekarreman.com/storage/posts/first.jpg"
                        draggable="false" alt="">
                    <img class="image image-track-img" src="http://www.dominiquekarreman.com/storage/posts/sixth.jpg"
                        draggable="false" alt="">
                    <img class="image image-track-img" src="http://www.dominiquekarreman.com/storage/posts/second.jpg"
                        draggable="false" alt="">
                    <img class="image image-track-img"
                        src="http://www.dominiquekarreman.com/storage/posts/fourth.jpeg" draggable="false"
                        alt="">
                    <img class="image image-track-img"
                        src="https://images.unsplash.com/photo-1599454100789-b211e369bd04?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1606&q=80"
                        draggable="false" alt="">
                    <img class="image image-track-img"
                        src="https://images.unsplash.com/photo-1573523765924-e6c704ce8048?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                        draggable="false" alt="">
                    <img class="image image-track-img"
                        src="https://images.unsplash.com/photo-1595835018349-198460e1d309?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1631&q=80"
                        draggable="false" alt="">
                    <img class="image image-track-img"
                        src="https://images.unsplash.com/photo-1567196884944-1b4b8f630560?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=80"
                        draggable="false" alt="">
                </div>
            </div>
