...
<body>
    ...
    <div class="showQuizContainer">
        <div class="showQuizCard">
            <h1>Create quiz</h1>
            <form method="POST" action="{{ route('quizes.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <textarea id="description" class="textarea @error('description') is-invalid @enderror" name="description" required></textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input type="file" id="qr_path" name="qr_path" accept="image/png, image/jpeg"
                            class="datetime @error('description') is-invalid @enderror" name="date"></input>
